...
Domain::Domain(double xPhysical)
{
    ...
    {
        points[i].updatePrimatives(1+0.1*i,1+0.1*i,0);
    }
    points[0].updatePrimatives(points[1].p, points[1].rho, -points[1].u);
    points[pointsSize-1].updatePrimatives(points[pointsSize-2].p, points[pointsSize-2].rho, -points[pointsSize-2].u);
}
