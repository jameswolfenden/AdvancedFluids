...
uBig = [u2(2:size(u2,1)-1,2:size(u2,2)-1), u0(2:size(u0,1)-1,2:size(u0,2)-1), u3(2:size(u3,1)-1,2:size(u3,2)-1); zeros(size(u1,1)-2,size(u2,2)-2), u1(2:size(u1,1)-1,2:size(u1,2)-1), zeros(size(u1,1)-2,size(u3,2)-2)];
figure
clims = [-1 1];
%imagesc(uBig, clims);
imagesc(uBig);
...
vBig = [v2(2:size(v2,1)-1,2:size(v2,2)-1), v0(2:size(v0,1)-1,2:size(v0,2)-1), v3(2:size(v3,1)-1,2:size(v3,2)-1); zeros(size(v1,1)-2,size(v2,2)-2), v1(2:size(v1,1)-1,2:size(v1,2)-1), zeros(size(v1,1)-2,size(v3,2)-2)];
figure
clims = [-2 2];
%imagesc(vBig, clims);
imagesc(vBig);
