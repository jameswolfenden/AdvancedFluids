...
n = Int(readdlm("resultsdomain/iterations.csv",',')[1] + 1)
# print the number of iterations(+1)
println("Number of iterations(+1): $(n)")

# read in the data
p0 = readdlm("resultsdomain/domain0p.csv",',')
p1 = readdlm("resultsdomain/domain1p.csv",',')
p2 = readdlm("resultsdomain/domain2p.csv",',')
p3 = readdlm("resultsdomain/domain3p.csv",',')
...
mp4(pAnim, "resultsdomain/p.mp4", fps=30)
...
rho0 = readdlm("resultsdomain/domain0rho.csv",',')
rho1 = readdlm("resultsdomain/domain1rho.csv",',')
rho2 = readdlm("resultsdomain/domain2rho.csv",',')
rho3 = readdlm("resultsdomain/domain3rho.csv",',')

println("Read in rho")

rhoAnim = Animation()
for i in toplay
    println("Creating frame $(i) of rho")
...
mp4(rhoAnim, "resultsdomain/rho.mp4", fps=30)
...
u0 = readdlm("resultsdomain/domain0u.csv",',')
u1 = readdlm("resultsdomain/domain1u.csv",',')
u2 = readdlm("resultsdomain/domain2u.csv",',')
u3 = readdlm("resultsdomain/domain3u.csv",',')

println("Read in u")

uAnim = Animation()
for i in toplay
    println("Creating frame $(i) of u")
...
mp4(uAnim, "resultsdomain/u.mp4", fps=30)
...
v0 = readdlm("resultsdomain/domain0v.csv",',')
v1 = readdlm("resultsdomain/domain1v.csv",',')
v2 = readdlm("resultsdomain/domain2v.csv",',')
v3 = readdlm("resultsdomain/domain3v.csv",',')

println("Read in v")

vAnim = Animation()
for i in toplay
    println("Creating frame $(i) of v")
...
mp4(vAnim, "resultsdomain/v.mp4", fps=30)
...
w0 = readdlm("resultsdomain/domain0w.csv",',')
w1 = readdlm("resultsdomain/domain1w.csv",',')
w2 = readdlm("resultsdomain/domain2w.csv",',')
w3 = readdlm("resultsdomain/domain3w.csv",',')

println("Read in w")

wAnim = Animation()
for i in toplay
    println("Creating frame $(i) of w")
...
mp4(wAnim, "resultsdomain/w.mp4", fps=30)
