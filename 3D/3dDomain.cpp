    ...
    for (int y = 1; y < domains[0]->yFaceCount; y++)
    {
        for (int i = 0; i < domains.size(); i++)
        {
            for (int z = 1; z < domains[i]->zFaceCount; z++)
            {
                ...
                {
                    stream << domains[i]->boxes[1][y][z].p;
                }
                else
                {
                    stream << domains[i]->boxes[1][y][z].p << ",";
...
int main()
{
    ...
    //double fridgeHeight = 0.15; // reduced size
    double pipeHeight = 0.1;
    ...
    //double rightFridgeWidth = 0.14; // reduced size
    double pipeDepth = 0.03;
    //double frontFridgeDepth = 0.12; // reduced size
    //double backFridgeDepth = 0.12; // reduced size
    ...
    iterationsStream << xCellsPerMetre << "\n";
    iterationsStream << yCellsPerMetre << "\n";
    iterationsStream << zCellsPerMetre;
